...
//use function Axiom\Rivescript\Cortex\Commands\TriggerCommand\str_starts_with;
/**
 * AtomicTrigger class
 *
 * Description:
 *
 * This class will detect and handle the definition of the "Atomic TriggerCommand"
 *
 * @see      https://www.rivescript.com/wd/RiveScript#Atomic-Trigger
 *
 *
 ...
 * @since    0.4.0
 */
class AtomicTrigger implements TriggerHandler
{
    /**
