...
test('getStream loader should work', function () {
    $this->assertIsResource($this->loader->getStream());
});

test('load() can load a single file', function () {
...
test('load() can load a multiple file passed as an array.', function () {
...
test('load() can load files in a given directory passed as string', function () {
